...
public class MainController {
	...
	@PostConstruct
	public void init() {
		// Users and Shelter first created
		...
		// Now animals adoptions and user galleries can be created
		
		Adoption adoption = new Adoption();
		adoption.setAdoptionUser(user2);
		adoption.setShelterOwner(shelter2);
		...
		animal1.setAdoption(adoption);
		animal1.setAnimalAdopter(user2);
		animal1.setAnimalOwner(shelter2);
		animal2.setAdoption(null);		
		animal2.setAnimalAdopter(null);
		animal2.setAnimalOwner(shelter1);
		...
		UserGalleryPhoto gallery = new UserGalleryPhoto(photo);
		gallery.setUserOwner(user2);
